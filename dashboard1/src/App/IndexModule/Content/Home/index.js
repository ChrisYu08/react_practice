				...
				<div className="container-fluid">
					...
					{/* <div className="row">
						<div className="col-xs-12 col-sm-6">
							<div className="widget-box">
								<div className="widget-title"><span className="icon"><i className="fa fa-file"></i></span><h5>Recent Posts</h5><span title="54 total posts" className="label label-info tip-left">54</span></div>
									...
									<ul className="recent-posts">
										<li>
											...
											<div className="article-post">
												<span className="user-info"> By: neytiri on 2 Aug 2012, 09:27 AM, IP: 186.56.45.7 </span>
												<p>
													<a href="#">Vivamus sed auctor nibh congue, ligula vitae tempus pharetra...</a>
												</p>
												<a href="#" className="btn index_btn-primary btn-xs">Edit</a> <a href="#" className="btn btn-success btn-xs">Publish</a> <a href="#" className="btn btn-danger btn-xs">Delete</a>
											</div>
										</li>
										<li>
											<div className="user-thumb">
											...
											<div className="article-post">
												<span className="user-info"> By: john on on 24 Jun 2012, 04:12 PM, IP: 192.168.24.3 </span>
												<p>
													<a href="#">Vivamus sed auctor nibh congue, ligula vitae tempus pharetra...</a>
												</p>
												<a href="#" className="btn index_btn-primary btn-xs">Edit</a> <a href="#" className="btn btn-success btn-xs">Publish</a> <a href="#" className="btn btn-danger btn-xs">Delete</a>
										...
										<li>
											...
											<div className="article-post">
												<span className="user-info"> By: michelle on 22 Jun 2012, 02:44 PM, IP: 172.10.56.3 </span>
												<p>
													<a href="#">Vivamus sed auctor nibh congue, ligula vitae tempus pharetra...</a>
												</p>
												<a href="#" className="btn index_btn-primary btn-xs">Edit</a> <a href="#" className="btn btn-success btn-xs">Publish</a> <a href="#" className="btn btn-danger btn-xs">Delete</a>
										...
										<li className="viewall">
											<a title="View all posts" className="tip-top" href="#"> + View all + </a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div className="col-xs-12 col-sm-6">
							<div className="widget-box">
								<div className="widget-title"><span className="icon"><i className="fa fa-comment"></i></span><h5>Recent Comments</h5><span title="88 total comments" className="label label-info tip-left">88</span></div>
								<div className="widget-content nopadding">
									<ul className="recent-comments">
										<li>
											...
											<div className="comments">
												<span className="user-info"> User: michelle on IP: 172.10.56.3 </span>
												<p>
													<a href="#">Vivamus sed auctor nibh congue, ligula vitae tempus pharetra...</a>
												</p>
												<a href="#" className="btn index_btn-primary btn-xs">Edit</a> <a href="#" className="btn btn-success btn-xs">Approve</a> <a href="#" className="btn btn-warning btn-xs">Mark as spam</a> <a href="#" className="btn btn-danger btn-xs">Delete</a>
											</div>
										</li>
										<li>
											<div className="user-thumb">
											...
											<div className="comments">
												<span className="user-info"> User: john on IP: 192.168.24.3 </span>
												<p>
													<a href="#">Vivamus sed auctor nibh congue, ligula vitae tempus pharetra...</a>
												</p>
												<a href="#" className="btn index_btn-primary btn-xs">Edit</a> <a href="#" className="btn btn-success btn-xs">Approve</a> <a href="#" className="btn btn-warning btn-xs">Mark as spam</a> <a href="#" className="btn btn-danger btn-xs">Delete</a>
										...
										<li>
											...
											<div className="comments">
												<span className="user-info"> User: neytiri on IP: 186.56.45.7 </span>
												<p>
													<a href="#">Vivamus sed auctor nibh congue, ligula vitae tempus pharetra...</a>
												</p>
												<a href="#" className="btn index_btn-primary btn-xs">Edit</a> <a href="#" className="btn btn-success btn-xs">Approve</a> <a href="#" className="btn btn-warning btn-xs">Mark as spam</a> <a href="#" className="btn btn-danger btn-xs">Delete</a>
										...
										<li className="viewall">
											<a title="View all comments" className="tip-top" href="#"> + View all + </a>
										</li>
									</ul>
								</div>
							</div>
					...
					<div className="row">
						<div className="col-xs-12">
							<div className="widget-box widget-calendar">
								<div className="widget-title"><span className="icon"><i className="fa fa-calendar"></i></span><h5>Calendar</h5></div>
								<div className="widget-content nopadding">
